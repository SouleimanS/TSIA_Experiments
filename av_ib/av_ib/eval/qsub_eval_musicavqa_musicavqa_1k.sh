#!/bin/bash
#PBS -N eval_mavqa_musicavqa_1k
#PBS -l select=1
#PBS -l walltime=05:00:00
#PBS -j oe
#PBS -o eval_musicavqa_musicavqa_1k.qsub.log
...
echo "=== Evaluating musicavqa_1k on Music-AVQA test ==="
python -u av_ib/eval/eval_musicavqa.py \
    --base-model  Qwen/Qwen3-Omni-30B-A3B-Instruct \
    --adapter     results/ckpts/musicavqa_1k/final \
