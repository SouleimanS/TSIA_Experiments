"""Evaluate a trained AVModelV6 checkpoint on MUSIC-AVQA val.
...
def main(args):
    print("=" * 60)
    print(f"v6 eval: {args.num_records} records from {args.ann_path}")
    ...
    with open(out_path, "w", newline="") as f:
        ...
        for idx, rec in enumerate(picked):
            ...
            writer.writerow([idx, rec["video_id"], prompt,
    ...
    print(f"\n{'='*60}")
    print(f"v6 eval done: {correct}/{args.num_records} = {acc:.2f}%")
