...
mkdir -p runs/v6_tier1

echo "=== v6 Tier 1: 1000 steps, beta=0, lr=1e-4, save every 100 ==="
python -u -m av_ib.train.train_v6 \
    ...
    --aux-weight 0.1 \
    --log-path runs/v6_tier1/log.jsonl \
    --ckpt-path runs/v6_tier1/final.pt \
    --save-every 10 \
    --print-every 50 \
    --save-every 100
