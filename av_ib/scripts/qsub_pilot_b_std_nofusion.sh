#!/bin/bash
#PBS -N pilot_b_std_nofusion
#PBS -P gae50891
#PBS -q rt_HF
#PBS -l select=1
#PBS -l walltime=12:00:00
#PBS -j oe
#PBS -o pilot_b_std_nofusion.qsub.log
...
mkdir -p runs/pilot_b_std_nofusion

echo "=== PILOT: v6 variant=b_std_nofusion | 2k samples seed=42 ==="
python -u -m av_ib.train.train_v6 \
    ...
    --aux-weight 0.1 \
    --log-path runs/pilot_b_std_nofusion/log.jsonl \
    --ckpt-path runs/pilot_b_std_nofusion/final.pt \
    --print-every 50
