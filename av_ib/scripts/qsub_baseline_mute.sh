...
mkdir -p "runs/corrupted_baseline_mute"
...
python -u -m av_ib.eval.qwen_omni_baseline \
    ...
    --max-records 1000 \
    --output-csv "runs/corrupted_baseline_mute/eval_1000.csv" \
    --output-json "runs/corrupted_baseline_mute/eval_1000.json"
echo "=== Done $(date) ==="
