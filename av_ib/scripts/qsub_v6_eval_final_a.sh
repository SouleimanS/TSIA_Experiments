#!/bin/bash
#PBS -N v6_eval_final_a
#PBS -P gae50891
#PBS -q rt_HF
#PBS -l select=1
#PBS -l walltime=04:00:00
#PBS -j oe
#PBS -o v6_eval_final_a.qsub.log
set -euo pipefail
cd "$PBS_O_WORKDIR"

OUTFILE="$PBS_O_WORKDIR/runs/qsub_v6_eval_final_a_out.txt"
