...
\begin{block}{Diagnosed \emph{why} the model ignores audio --- it's the benchmark}
  Causal per-modality ablation on MUSIC-AVQA: removing video barely changes the
  model's answer ($+4.4$\,\% NLL), and only $\sim$0.5\,\% of questions are
  genuinely audio-visual. The benchmark structurally \textbf{cannot} test an AV
  bottleneck.
\end{block}
...
\begin{block}{Causal per-modality ablation}
{\footnotesize
