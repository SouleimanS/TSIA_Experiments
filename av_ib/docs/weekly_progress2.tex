...
{\footnotesize
Video channel rate $\mathrm{KL}_v$: $10779 \to 4103$ over training
(\textbf{2.6$\times$ compression}) at near-constant accuracy.\\[3pt]
Meanwhile the audio rate is \emph{stuck}: $\mathrm{KL}_a$ $494 \to 486$ --- the
audio bottleneck has nothing to learn (no task signal), so we leave audio
untouched.\\[3pt]
